        ...
        <div class="col-4 col-md-7 page-hdr-left">
            ...
            <div id="logo">
                <div class="tbl-cell logo-icon">
                    <a href="#"><img src="{{ asset('assets/img/SIA.png') }}"></a>
                </div>
        ...
        <div class="col-8 col-md-5 page-hdr-right">
            <div class="page-hdr-desktop">
                <div class="page-menu menu-dropdown-wrapper menu-user">
                    <a class="user-link">
                        <span class="tbl-cell user-name pr-3">Hello <span class="pl-2">{{ Auth::User()->name }}</span></span>
                        <span class="tbl-cell avatar"><img src="{{ asset('assets/img/user.png') }}"></span>
                    </a>
                    <div class="menu-dropdown menu-dropdown-right menu-dropdown-push-right">
                        ...
                        <div class="menu-dropdown-inner">
                            ...
                            <div class="menu-dropdown-footer text-right">
                                <a href="{{ route('auth.logout') }}" class="btn btn-outline btn-primary btn-pill btn-outline-2x font-12 btn-sm">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
